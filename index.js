...
/* console.log hadn't been declared because it had been commented. I deleted the comment tags and fixed the function by replacing the ; with a parentheses
*/
...
// myVariable was not defined and hadn't been declared. I fixed it by declaring using the var sintax and deleted the ; //
...
// Greeting isn't a function and was being called as if it was one. I fixed it by using it's name directly, and to display it I used console.log. Since it's not a function it is not needed to use () parentheses.
...
// the let property was not properly set up, it was missing the property syntax which made the property undefined. I fixed this by creating a list and defining property as "object"//
...
console.log("User info: " + user.name + " " + user.age); // Output: User info: [object Object]
// The values of variables weren't being called correctly. Since the whole variable was being declared I had to fix it by calling the values of the variable individually.
...
//The code is not adding 10 and 5 because it thinks 5 as a string so instead it puts it right next to 10. I used parseInt to convert the string 10 into an integer.